...
title: "Add Guardrails to a LangChain Chain"
sidebar-title: "Chain with Guardrails"
...
To protect against such attempts, we can use a guardrails configuration. In the configuration below, we use the [self-check input rails](/configure-guardrails/guardrail-catalog/self-check#self-check-input).
...
In this guide, you learned how to apply a guardrails configuration to an existing LangChain chain (or `Runnable`). For more details, check out the [RunnableRails guide](/integration-with-third-party-libraries/langchain/runnable-rails).
