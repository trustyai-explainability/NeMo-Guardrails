...
sidebar-title: "LangChain Integration"
...
For more details, check out the [Agent Middleware Guide](/integration-with-third-party-libraries/langchain/agent-middleware).
...
For more details, check out the [RunnableRails Guide](/integration-with-third-party-libraries/langchain/runnable-rails) and the [Chain with Guardrails Guide](/integration-with-third-party-libraries/langchain/chain-with-guardrails).
...
For a complete example, check out the [Runnable as Action Guide](/integration-with-third-party-libraries/langchain/runnable-as-action).
