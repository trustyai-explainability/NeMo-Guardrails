...
For more details on embedding model configuration, refer to [Model Configuration](/configure-guardrails/yaml-schema/model-configuration).
...
For more details, refer to [Embedding Search Providers](/configure-guardrails/other-configurations/embedding-search-providers).
