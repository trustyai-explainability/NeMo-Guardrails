...
sidebar-title: "Hallucinations & Fact-Checking"
...
For more details, check out the [AlignScore Integration](/configure-guardrails/guardrail-catalog/third-party/alignscore) page.
