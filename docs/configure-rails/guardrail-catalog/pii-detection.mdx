...
> ```
>
> See the [GLiNER Integration — Deploy NIMs Locally](/configure-guardrails/guardrail-catalog/third-party/gliner#start-the-containers) section for full `docker run` instructions.
...
See the [GLiNER Integration](/configure-guardrails/guardrail-catalog/third-party/gliner) page for Docker pull and run instructions.
...
For more details, check out the [Presidio Integration](/configure-guardrails/guardrail-catalog/third-party/presidio) page.
