...
title: "NeMo Guardrails Library Configuration Overview"
sidebar-title: "Configuration Overview"
description: "Learn to write config.yml, Colang flows, and custom actions for guardrails."
keywords:
    [
        "nemo guardrails overview",
        "guardrails configuration structure",
...
- [Configuring YAML File](/configure-guardrails/yaml-schema) - A complete guide to writing your `config.yml` file.
- [Colang](/configure-guardrails/colang) - `.co` flow files in `rails` folder.
- [Custom Actions](/configure-guardrails/actions) - `actions.py` or `actions/` folder for callable actions.
- [Custom Initialization](/configure-guardrails/custom-initialization) - `config.py` for custom initialization.
- [Knowledge Base](/configure-guardrails/other-configurations/knowledge-base) - `kb/` folder for RAG.
...
For detailed SDK usage, including loading configurations, generating responses, streaming, and debugging, refer to [About Running Guardrailed Inference](/run-guardrailed-inference/run-rails).
