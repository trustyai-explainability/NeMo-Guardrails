...
title: "More on Flows"
description: "In section Defining Flows, we learned the core mechanisms of flows. In this section will look at more advanced topics that are related to flows."
---

<a id="more-on-flows"></a>


In section [Defining Flows](defining-flows#defining-flows), we learned the core mechanisms of flows. In this section will look at more advanced topics that are related to flows.

<a id="more-on-flows-activate-a-flow"></a>
...
<a id="more-on-flows-start-a-new-flow-instance"></a>
...
<a id="more-on-flows-deactivate-a-flow"></a>
...
```
<a id="more-on-flows-override-flows"></a>
...
<a id="more-on-flows-interaction_loops"></a>
...
<a id="more-on-flows-flow-conflict-resolution-prioritization"></a>

## Flow Conflict Resolution Prioritization

In section [Defining Flows](defining-flows#defining-flows-concurrent-pattern-matching), we have already learned a bit about the mechanics of resolving an action conflict between flows. We will now look at this in more detail.
