...
title: "Flow control"
description: "Flow control is an essential tool in all programming languages, and Colang supports this as well. It enables branching and repetition of interaction patterns in a single flow."
---
...
<a id="flow-control-event-branching"></a>
...
```
<a id="flow-control-return-abort"></a>
