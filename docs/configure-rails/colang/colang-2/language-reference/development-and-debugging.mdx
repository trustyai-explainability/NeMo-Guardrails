...
description: "Currently, the Colang story designing and building environment is fairly limited, but will be improved on in the future."
---
...
- We suggest using [Visual Studio Code](https://code.visualstudio.com/) and the Colang highlighting extension ([GitHub link](https://github.com/NVIDIA-NeMo/Guardrails/tree/main/vscode_extension)) to help with highlighting Colang code.
- You can use the Visual Studio Code launch setting to run a Colang story with nemoguardrails in a python environment by pressing F5 ([launch.json](https://github.com/NVIDIA-NeMo/Guardrails/blob/main/.vscode/launch.json)).
