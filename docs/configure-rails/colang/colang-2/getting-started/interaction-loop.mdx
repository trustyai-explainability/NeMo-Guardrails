...
description: "This section explains how to create an interaction loop in Colang 2.0."
---

<a id="colang_2_getting_started_interaction_loop"></a>
...
```
The [next example](llm-flows#colang_2_getting_started_llm_flows) will show you how to create LLM-driven flows.
