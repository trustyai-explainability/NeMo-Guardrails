...
description: "This guide provides a non-comprehensive overview of the most important changes in Colang 2.0."
---
...
For more details see [Defining Flows](language-reference/defining-flows#flow-naming-conventions).
...
<a id="whats-changed-alpha-to-beta"></a>
