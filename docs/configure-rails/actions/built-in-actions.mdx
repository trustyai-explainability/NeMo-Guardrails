...
sidebar-title: "Built-in Actions"
description: "Reference for default actions included in the NeMo Guardrails library."
keywords: ["nemo guardrails built-in actions", "guardrails self check input", "guardrails self check output", "llama guard check", "jailbreak detection action"]
content:
  type: "reference"
---
