...
title: "Registering Custom Actions"
sidebar-title: "Registering Actions"
description: "Register custom actions via actions.py, LLMRails.register_action(), or config.py."
keywords: ["nemo guardrails register action", "guardrails actions.py", "LLMRails register_action", "langchain tool registration", "actions server guardrails"]
content:
  type: "how_to"
---
