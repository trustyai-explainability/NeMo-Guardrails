...
title: "Restrict Topics with Llama 3.1 NemoGuard 8B TopicControl NIM"
sidebar-title: "Restrict Topics"
...
- [Topic Safety overview](/configure-guardrails/guardrail-catalog/topic-control)
...
- [NeMo Guardrails Library Configuration Guide](/configure-guardrails/overview)
