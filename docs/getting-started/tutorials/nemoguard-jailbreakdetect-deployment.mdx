...
title: "Detect Jailbreak Attempts with NVIDIA NemoGuard JailbreakDetect NIM"
sidebar-title: "Detect Jailbreak Attempts"
...
1. Save the following as `config/config.yml`:
   ...
   For more information about the configuration parameters, refer to the [Configuration Reference](/configure-guardrails/configuration-reference).
...
- [Configuration Reference](/configure-guardrails/configuration-reference) for all configuration options
