...
title: "Event-Based API"
sidebar-title: "Event-Based API"
...
You can use a guardrails configuration through an event-based API using `LLMRails.generate_events_async` and `LLMRails.generate_events`. For the full API reference, see [Python SDK Reference](/guardrails-python-sdk/nemoguardrails).
