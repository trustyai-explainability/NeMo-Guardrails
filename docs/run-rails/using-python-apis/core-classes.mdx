...
The `RailsConfig` class represents a complete guardrails configuration, including models, rails, flows, prompts, and other settings. This class requires to load the configuration from a directory or a single file you created in the previous chapter [About Configuring Guardrails](/configure-guardrails/configure-rails).
...
For detailed information about context variables, see [Action Parameters: The Context Parameter](/configure-guardrails/actions/action-parameters#the-context-parameter) and [Colang 1.0 Language Syntax: Variables](/configure-guardrails/colang/colang-1/colang-language-syntax-guide#variables).
...
For detailed streaming configuration, refer to [Streaming](/run-guardrailed-inference/using-python-apis/streaming).
...
For detailed event-based API usage, refer to [Event-Based API](/run-guardrailed-inference/using-python-apis/event-based-api).
...
For detailed action registration, refer to [Custom Actions](/configure-guardrails/actions).
...
- [Generation Options](/run-guardrailed-inference/using-python-apis/generation-options) - Fine-grained control over generation
- [Check Messages](/run-guardrailed-inference/using-python-apis/check-messages) - Validate messages against rails
- [Streaming](/run-guardrailed-inference/using-python-apis/streaming) - Real-time token streaming
- [Event-Based API](/run-guardrailed-inference/using-python-apis/event-based-api) - Low-level event control
- [Tools Integration](/integration-with-third-party-libraries/tools-integration) - Integrating LangChain tools
- [About Configuring Guardrails](/configure-guardrails/configure-rails) - Complete configuration reference
