...
title: "Chat with Guardrailed Model"
sidebar-title: "Chat Completions"
...
For complete details on generation options, see [Create Chat Completion](api:POST/v1/chat/completions).
